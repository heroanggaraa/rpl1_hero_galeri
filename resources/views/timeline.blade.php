...
<div class="wrapper">
  ...
  <nav class=" navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="modal" data-target="#Modallogout" href="#" role="button">
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    <img class="img-fluid" width="400" height="400" src="{{ asset('image/'.$galeri->foto) }}" alt="Photo">
                    <br>
